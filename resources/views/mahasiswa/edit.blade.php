        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <div class="card-body">   
                    ...
                    <label for="kd_makul">Nama Mahasiswa</label>
                    ...
                    <input type="number" name="npm" class="form-control col-md-6" placeholder="Masukkan NPM" maxlength="8" value="{{ is_null
                    ($mahasiswa) ? '' : $mahasiswa->npm }}">
                    </div>

                    <div class="form-group">
                    <label for="tempat_lahir">Tempat Lahir</label>
                    <input type="text" name="tempat_lahir" class="form-control col-md-6" placeholder="Masukkan Tempat Lahir" value="{{ is_null
                    ($mahasiswa) ? '' : $mahasiswa->tempat_lahir }}">
                    </div>

                    <div class="form-group">
                    <label for="tgl_lahir">Tanggal Lahir</label>
                    <input type="date" name="tgl_lahir" class="form-control col-md-6" placeholder="Masukkan Tanggal Lahir" value="{{ is_null
                    ($mahasiswa) ? '' : $mahasiswa->tgl_lahir }}">
                    </div>

                    <div class="form-group">
                    <label for="gender">Jenis Kelamin</label>
                    <select name="gender" id="gender" class="form-control col-md-6" value="{{ is_null
                    ...
                    <input type="number" name="telepon" class="form-control col-md-8" placeholder="Masukkan Nomor Telepon" maxlength="13" value="{{ is_null
